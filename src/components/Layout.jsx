...
export default function Layout() {
  ...
  return (
    <div className="flex h-screen overflow-hidden" style={{ background: 'hsl(35,40%,96%)' }}>
      ...
      >
        {(() => {
          ...
          return (
            <div className={cn("flex items-center gap-3 px-4 py-5", collapsed && "justify-center px-2")}
              ...
              {!collapsed && (
                <div>
                  <p className="font-bold text-sm leading-tight" style={{ color: '#F59E0B' }}>{titulo}</p>
        ...
        <div className="p-3" style={{ borderTop: '1px solid rgba(255,255,255,0.1)' }}>
          <button
            ...
            onMouseEnter={e => { e.currentTarget.style.background = 'rgba(245,158,11,0.12)'; e.currentTarget.style.color = '#fff'; }}
