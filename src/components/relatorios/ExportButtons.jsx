  ...
  return (
    <div className="flex items-center gap-1.5">
      <button
        ...
        className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold border border-rainbow-green/40 text-rainbow-green bg-rainbow-green/10 hover:bg-rainbow-green/20 transition-colors disabled:opacity-50"
      >
        <Download size={12} />
      ...
      <button
        ...
        className="flex items-center gap-1.5 px-3 py-1.5 rounded-lg text-xs font-semibold border border-rainbow-red/40 text-rainbow-red bg-rainbow-red/10 hover:bg-rainbow-red/20 transition-colors disabled:opacity-50"
      >
        <FileText size={12} />
