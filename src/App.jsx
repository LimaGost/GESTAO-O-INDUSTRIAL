...
import PedidosAgrupados from './pages/PedidosAgrupados.jsx';
    ...
    <PermissoesProvider user={user}>
      <AnimatedRoutes>
        ...
        <Route element={<Layout />}>
          ...
          <Route path="/PedidosAgrupados" element={<RotaProtegida modulo="Pedidos"><PedidosAgrupados /></RotaProtegida>} />
