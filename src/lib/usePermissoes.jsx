...
const DEFAULTS = {
  ...
  motorista:        { Dashboard: 'view', Pedidos: 'none', Kanban: 'none', Separacao: 'view', SeparacaoGalpao: 'none', Estoque: 'none', Embalagem: 'none', Etiquetas: 'none', Expedicao: 'full', Clientes: 'none', Produtos: 'none', Relatorios: 'none', Perdas: 'none', Faturamento: 'none', Precos: 'none', Auditoria: 'none', Configuracoes: 'none' },
  estoquista_industria: { Dashboard: 'view', Pedidos: 'view', Kanban: 'view', Separacao: 'full', SeparacaoGalpao: 'none', Estoque: 'full', Embalagem: 'none', Etiquetas: 'full', Expedicao: 'none', Clientes: 'none', Produtos: 'view', Relatorios: 'none', Perdas: 'view', Faturamento: 'none', Precos: 'none', Auditoria: 'none', Configuracoes: 'none', PostoTrabalho: 'full' },
