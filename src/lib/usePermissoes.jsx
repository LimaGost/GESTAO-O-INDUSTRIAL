...
const DEFAULTS = {
  ...
  motorista:        { Dashboard: 'view', Pedidos: 'view', Kanban: 'view', Separacao: 'view', SeparacaoGalpao: 'view', Estoque: 'none', Embalagem: 'none', Etiquetas: 'none', Expedicao: 'full', Clientes: 'none', Produtos: 'none', Relatorios: 'none', Perdas: 'none', Faturamento: 'none', Precos: 'none', Auditoria: 'none', Configuracoes: 'none' },
